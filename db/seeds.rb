...
books_data = [
  ...
  },
  {
    ...
    author: "Various Authors",
    yomiyasusa_level: "3.0-3.8",
    word_count: "15000-35000",
    isbn: ""
  },
...
books_data.each do |book_attrs|
  Book.find_or_create_by!(title: book_attrs[:title]) do |book|
    ...
    book.isbn = book_attrs[:isbn].present? ? book_attrs[:isbn] : nil
  end
  print "."
end
